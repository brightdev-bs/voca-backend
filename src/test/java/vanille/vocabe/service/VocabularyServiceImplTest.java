...
class VocabularyServiceImplTest {
    ...
    void findAllVocabularies() {
        ...
        vocabularies.add(UserVocabulary.of(user, VocabularyFixture.getVocabularyFixture("test"), VocabularyType.CREATED));
        vocabularies.add(UserVocabulary.of(user, VocabularyFixture.getVocabularyFixture("test2"), VocabularyType.CREATED));
        vocabularies.add(UserVocabulary.of(user, VocabularyFixture.getVocabularyFixture("test3"), VocabularyType.CREATED));

        User user2 = UserFixture.getVerifiedUser("teseter2");
        List<UserVocabulary> vocabularies2 = user2.getVocabularies();
        vocabularies2.add(UserVocabulary.of(user2, VocabularyFixture.getVocabularyFixture("test222"), VocabularyType.CREATED));
